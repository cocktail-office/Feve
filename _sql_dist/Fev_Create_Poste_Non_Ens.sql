CREATE OR REPLACE PROCEDURE MANGUE.Fev_Create_Poste_Non_Ens IS
          ...
          LOOP
             ...
             if (nb_poste_existant = 0) then
                ...
                SELECT NOM_USUEL||' '||PRENOM INTO nom_prenom FROM GRHUM.INDIVIDU_ULR WHERE NO_INDIVIDU = aff_lgn.no_dossier_pers;
                 ...
                 (la_pos_key, 'Poste non enseignant de '||nom_prenom|| ' (création automatique le '||to_char(sysdate, 'dd/mm/yyyy')||')', SYSDATE, SYSDATE, le_pos_code, aff_lgn.d_deb_affectation,NULL, aff_lgn.c_structure);
                 ...
                 (la_flo_key, la_pos_key, to_date('01/01/'||str_annee,'dd/mm/yyyy'), to_date('31/12/'||str_annee,'dd/mm/yyyy'), sysdate, sysdate, 2010); 
